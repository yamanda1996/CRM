...
<BODY>
	<FORM id=form1 name=form1
		action="${pageContext.request.contextPath }/customer_selectCustomer.action"
		method="post" >
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>客户名称：</td>
								<td colspan="3">  <!-- 把域对象中的集合放到下拉列表中 -->
									<%-- <select name="customer.cid">    <!-- 这样写就可以直接把cid值封装到linkman对象中的customer对象中 -->
										<c:forEach items="${listCustomer }" var="customer">
											<option value="${customer.cid }">${customer.cust_name }</option>
										</c:forEach>
									</select> --%>
