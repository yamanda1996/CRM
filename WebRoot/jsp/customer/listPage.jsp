								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><%-- <s:property value="#pageBean.totalCount" />  --%>${requestScope.pageBean.totalCount }</B>]条记录,
												共[<B><%-- <s:property value="#pageBean.totalPage" /> --%>${requestScope.pageBean.totalPage }</B>]页，
												当前第[<b>${requestScope.pageBean.currentPage }</b>]
